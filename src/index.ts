...
Complete the user's search request efficiently and report your findings clearly.`,
    ...
    },
    {
      name: "oracle",
      whenToUse:
        "Expert advisor for architecture decisions, code reviews, and strategic planning. Use when you need high-quality technical guidance, effort estimates, or a second opinion on complex decisions. Provides structured responses with TL;DR, approach, trade-offs, and risks.",
